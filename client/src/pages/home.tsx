...
export default function Home() {
  ...
  if (isLoading) {
    return (
      <div className="p-4">
        <div className="bg-gray-200 animate-pulse rounded-xl h-24 mb-6"></div>
  ...
  return (
    <div className="p-4">
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-2xl font-bold text-rose-ebony">{stats.freshItems}</p>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
          <div className="flex items-center">
            ...
            <div>
              <p className="text-2xl font-bold text-rose-ebony">{stats.expiringItems}</p>
      ...
      {/* Recent Activity */}
      <div className="mb-6">
        <h3 className="text-lg font-semibold text-rose-ebony mb-3">Recent Activity</h3>
        {recentActivity.length === 0 ? (
          ...
          recentActivity.map((item) => {
            ...
            return (
              <div key={item.id} className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 mb-3">
                <div className="flex items-center">
                  <div className="w-10 h-10 bg-mint-cream rounded-lg flex items-center justify-center mr-3">
                    <Plus className="text-apple-green" size={16} />
                  </div>
                  <div className="flex-1">
                    <p className="font-medium text-rose-ebony">Added {item.name}</p>
